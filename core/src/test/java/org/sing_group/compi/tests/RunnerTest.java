...
public class RunnerTest {
  ...
  public void testJAXB() throws SAXException, IOException, JAXBException {
    ...
    assertEquals(2, runners.getRunners().size());
    assertEquals("t1,t2", runners.getRunners().get(0).getTasks());
  }
  ...
  public void testSimpleRunnerConfiguration() throws IllegalArgumentException, JAXBException,
    ...
    try {
      ...
      final CompiApp compi = new CompiApp(pipelineFile, 1, (var) -> var.equals("my-var")?"hello":null, null, null);
      ...
      assertTrue(runner_results_contents.contains("[t3] iteration-value: 2 my-var: hello code: echo 2 >> /tmp/t3-result"));
