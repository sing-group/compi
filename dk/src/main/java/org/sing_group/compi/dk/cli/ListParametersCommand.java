...
public class ListParametersCommand extends AbstractCommand {
  ...
  public String getDescriptiveName() {
    return "Lists pipeline parameters";
  }
  ...
  private static void simpleReport(Pipeline pipeline) {
    pipeline.getParameterDescriptions().forEach(p -> {
      System.out.println(p.getName());
    });
  }

  private static void completeReport(Pipeline pipeline) {
    System.out.println("name\tshort name\tdefault value\tdescription");
    ...
    pipeline.getParameterDescriptions().forEach(p -> {
      ...
      sb
        ...
        .append("\t")
        .append(asString(p.getDefaultValue()))
        .append("\t")
